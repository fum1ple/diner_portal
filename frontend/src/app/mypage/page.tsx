...
export default function MyPage() {
  ...
  return (
    <div className="container-fluid py-4" style={{ backgroundColor: '#f4f5f6' }}>
            ...
            <div className="mb-3">
              <ul className="nav nav-pills">
                <li className="nav-item">
                  <button 
                    className={`nav-link rounded-pill px-4 py-2 ${activeTab === TabType.AddedRestaurants ? 'active' : 'text-secondary'}`}
                ...
                <li className="nav-item">
                  <button 
                    className={`nav-link rounded-pill px-4 py-2 ${activeTab === TabType.ReviewedRestaurants ? 'active' : 'text-secondary'}`}
                ...
                <li className="nav-item">
                  <button 
                    className={`nav-link rounded-pill px-4 py-2 ${activeTab === TabType.Favorites ? 'active' : 'text-secondary'}`}
