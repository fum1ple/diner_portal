# This file was generated by the `rails generate rspec:install` command. Conventionally, all specs live under a `spec` directory, which RSpec adds to the `$LOAD_PATH`.
...
RSpec.configure do |config|
  ...
  # you do not change this unless you know what you're doing.
  config.example_status_persistence_file_path = "spec/examples.txt"

  # Limits the available syntax to the non-monkey patched syntax that is recommended.
  # For more details, see:
  #   - https://rspec.info/blog/2012/06/rspecs-new-expectation-syntax/
  #   - https://rspec.info/blog/2012/06/rspecs-new-mock-syntax/
  #   - https://rspec.info/blog/2014/05/notable-changes-in-rspec-3/
